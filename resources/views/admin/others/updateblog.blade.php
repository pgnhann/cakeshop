...
@section("content")
    <!-- <div>
        <center> <h3 style="font-size: 20px;"> CẬP NHẬT BÀI BLOG </h3> </center>
    </div>

    <div class="updateblog-wrapper">
            <form action="{{ url('/quanly/blog/updated/'. $blog->stt) }}" method="post">
            @csrf
            <table class="updateblog-table">
                ...
                <div class = "blogupdate-button-container">
